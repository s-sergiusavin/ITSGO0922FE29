...
console.log(testLet);
    ...
    let globalLetVariable = "unchange";
    ...
    // console.log(functionVariable); eroare fiindca nu este declarata in exteriorul functiei
    ...
    // console.log(testCity); nu poate fi folosita variabila inainte folosita inainte de declaratie;
    const testCity = "City";
    ...
    // console.log(complexObject.drink);
    // complexObject.drink();
    // console.log(console);
    ...
    const orderPizza = (i1, i2, i3) => {
        ...
        console.log("Pizza cu ingredientele ")
