...
/**
 * Method to geth html element by id
 */
...
paragraphElem[0].innerHTML = 'This text was edith later with JS';
...
function blurInput(){
    ...
    greenBox.style.backgroundColor = "bluemarin";
...
document.getElementById('readValueInput').value = 'Cristine';