    ...
    if (
      ...
      if (isLoginPage) {
        ...
        login(emailValue, passwordValue).then((data) => {
          ...
          window.open("pages/feed/indexsocial.html", "_blank");
          //mnai pot avea pe langa primul param inca unul optioonal unde ii spun cum sa imi deschida fereastra. new window, same window etc
        });
